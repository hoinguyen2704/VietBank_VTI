...
import com.vti.vietbank.entity.*;
...
public class TransactionServiceImpl implements TransactionService {
    ...
    public ApiResponse<TransactionResponse> transfer(TransferRequest request, Authentication authentication) {
        ...
        if (fromAccount.getStatus() != com.vti.vietbank.entity.enums.AccountStatus.ACTIVE) {
        ...
        if (toAccount.getStatus() != com.vti.vietbank.entity.enums.AccountStatus.ACTIVE) {
        ...
        // Send real-time notifications to both sender and receiver
        try {
            Long fromUserId = fromAccount.getCustomer().getUser().getId();
            Long toUserId = toAccount.getCustomer().getUser().getId();
            ...
            notificationService.sendTransferNotification(
                    ...
                    transferOut.getTransaction_code(),
    ...
    @Override
    public ApiResponse<TransactionResponse> getById(Long id) {
    ...
    @Override
    public ApiResponse<List<TransactionResponse>> getByAccountId(Long accountId) {
    ...
    @Override
    public ApiResponse<List<TransactionResponse>> getByCustomerId(Long customerId) {
    ...
    @Override
    public ApiResponse<Boolean> checkStaffExists(Long staffId) {
    ...
    private TransactionResponse convertToTransactionResponse(TransactionHistory transaction) {
        ...
        return new TransactionResponse(
                ...
                transaction.getRelated_account_id() != null ? transaction.getRelated_account_id().getAccountNumber()
                        : null,
                transaction.getRelated_account_id() != null ? transaction.getRelated_account_id().getAccountName()
                        : null, // Thêm relatedAccountName
                transaction.getRelated_account_id() != null
                        ? transaction.getRelated_account_id().getCustomer().getFullName()
                        : null,
    ...
    @Override
    public ApiResponse<PageResponse<TransactionDetailResponse>> searchComplexTransactions(
            TransactionComplexSearchRequest request) {
