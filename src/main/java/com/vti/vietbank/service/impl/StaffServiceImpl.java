...
import com.vti.vietbank.service.StaffService;
...
public class StaffServiceImpl implements StaffService {
    ...
    @Override
    @Transactional
    public ApiResponse<StaffResponse> update(Long id, UpdateStaffRequest request) {
        Staff staff = staffRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Staff", "id", id));
    ...
    @Override
    public ApiResponse<List<StaffResponse>> getByDepartmentId(Long departmentId) {
